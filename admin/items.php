  ...
  if (isset($_SESSION['Username'])){
      ...
      <h1 class="text-center">Add New Items</h1>
         <div class="container">
          <form class="form-horizontal" action="?do=Insert" method="POST">
            ...
            <!--start Price field -->
              <div class="form-group form-group-lg">
              <label class="col-sm-2 control-labal">Price</label>
              <div class="col-sm-10  col-md-4">
                <input
                       type="text"
                       name="price"
            ...
            <!--start Country field -->
              <div class="form-group form-group-lg">
              <label class="col-sm-2 control-labal">Country</label>
              <div class="col-sm-10  col-md-4">
                <input
                       type="text"
                       name="country"
            ...
            <!--start Status field -->
              <div class="form-group form-group-lg">
              <label class="col-sm-2 control-labal">Status</label>
              <div class="col-sm-10  col-md-4">
            ...
            <!--start Member field -->
              <div class="form-group form-group-lg">
              <label class="col-sm-2 control-labal">Member</label>
              <div class="col-sm-10  col-md-4">
            ...
            <!--start Category field -->
              <div class="form-group form-group-lg">
              <label class="col-sm-2 control-labal">Category</label>
              <div class="col-sm-10  col-md-4">
    ...
    <?php
          ...
          //Get varibale from form 
            ...
            // Validate the form 
             ...
             if(empty($formErrors)){
              ...
              $stmt3->execute(array($name, $desc, $price, $country, $status, $cat, $member,$tags, $id));

              // echo success messege

              $theMsg = "<div class='alert alert-success'>". $stmt3->rowCount() . ' Record Update</div>';
      ...
      echo "<h1 class='text-center'>Delete Item</h1>";
              echo "<div class='container'>";
       //Check if get request itemid numeric 
        $itemid = isset($_GET['itemid']) && is_numeric($_GET['itemid']) ? intval($_GET['itemid']): 0;
       ...
       //Check if get itemid request  numeric 
        $itemid = isset($_GET['itemid']) && is_numeric($_GET['itemid']) ? intval($_GET['itemid']): 0;
        $check = checkItem('Item_ID','items',$itemid);
